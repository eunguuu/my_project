...
<div id="solution_w">
<article id="gal">
<h1 style="margin-left: 180px;">글 작성</h1>
<form action="gwritePro.jsp" method="post" enctype="multipart/form-data">
<table id="fwrite" style="float: left; margin-left: 180px;">
<tr><td class="h">작성자</td><td colspan="2" class="d"><input type="text" name="name" value="admin" readonly></td></tr>
...
<tr><td class="h">글내용</td>
    <td colspan="2" class="c"><textarea name="content" rows="7" cols="40"></textarea></td></tr>
</table>
