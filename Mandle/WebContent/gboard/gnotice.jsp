...
List boardList = bdao.getgBoardList(startRow, pageSize);
%>
<article id="gal">
<h1>PORTFOLIO</h1>
<h2>전체 글 갯수 [<%=count%>]</h2>
...
%>
   <td class="gtd" onclick="location.href='gcontent.jsp?num=<%=bb.getNum()%>'"><img src="../upload/<%=bb.getFile()%>" width="170">
  <%=bb.getSubject() %>
  <%=bb.getName() %>
                     <%=sdf.format(bb.getDate()) %></td>
<%
	oneLine++;
